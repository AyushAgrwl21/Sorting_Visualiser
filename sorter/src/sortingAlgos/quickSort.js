...
//     quickSortHelper(array, 0, array.length - 1,animationsQS);
//     return animationsQS;
//   }

//   function quickSortHelper(array, left, right,animationsQS) {
//     var index;
//     if (array.length > 1) {
//         index = partition(array, left, right,animationsQS); //index returned from partition
//         if (left < index - 1) { //more elements on the left side of the pivot
//             quickSortHelper(array, left, index - 1,animationsQS);
//         }
//         if (index < right) { //more elements on the right side of the pivot
//             quickSortHelper(array, index, right,animationsQS);
//         }
//     }
//     return array;
//   }

//   function swap(array, leftIndex, rightIndex,animationsQS){
//     animationsQS.push(leftIndex.rightIndex)
//     var temp = array[leftIndex];
//     array[leftIndex] = array[rightIndex];
//     array[rightIndex] = temp;
//   }

//   function partition(array, left, right,animationsQS) {
...
//         if (i <= j) {
//           animationsQS.push(i,j);
//           animationsQS.push(i,j);
//           swap(array, i, j,animationsQS); //sawpping two elements
//           i++;
//           j--;
//         }
//     }
